...
<style>
  ...
  .ok { padding: 16px; background: var(--color-bg2); border: 1px solid var(--color-acc); border-radius: 8px; font-family: var(--font-mono); font-size: 11px; line-height: 1.7; color: var(--color-t2); }
  .ok-title { color: var(--color-acc); font-weight: 700; margin-bottom: 6px; }
  .ok b { color: var(--color-text); }
  .field { margin-bottom: 16px; }
  .field label { display: block; font-family: var(--font-mono); font-size: 10px; color: var(--color-t2); margin-bottom: 6px; text-transform: uppercase; letter-spacing: 1px; }
  .field input { width: 100%; padding: 12px; font-size: 13px; }
  .err { padding: 10px; background: #ff000010; border: 1px solid #ff000040; border-radius: 6px; color: var(--color-acc2); font-family: var(--font-mono); font-size: 10px; margin-bottom: 14px; }
